...
module TestWiseSupport
  ...
  def operation_delay
    begin    		
      ...
      while $TESTWISE_PAUSE || $TESTWISE_PAUSE
        Thread.pass
  ...
  def dump_caller_stack
    return unless ($TESTWISE_TRACE_EXECUTION || $TESTWISE_TRACE_EXECUTION)
    begin
      trace_lines = []
      trace_file = nil
  ...
  def connect_to_testwise (message_type, body)
    ...
    begin
      ...
      itest_port = $TESTWISE_TRACE_PORT || $TESTWISE_TRACE_PORT || 7025
